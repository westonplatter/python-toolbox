...
# lock '3.3.5'
#
# set :application, 'htd_india'
# set :repo_url, 'git@github.com:westonplatter/idx.git'
#
# # Default branch is :master
# # ask :branch, proc { `git rev-parse --abbrev-ref HEAD`.chomp }.call
#
# # Default deploy_to directory is /var/www/my_app_name
# set :deploy_to, '/var/www/htd_india'
#
...
# # rollbar
# #
# set :rollbar_token, 'e9869174f80c4aa0bbd1837d60846a40'
